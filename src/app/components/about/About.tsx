  ...
  return (
    ...
    <div className='h-full grid place-items-center' data-aos="fade-up" data-aos-delay="200"> 
        <div className='gap-2 lg:gap-5 space-y-1 lg:space-y-2' >
            ...
            <Link href='/' >
            <Button dataAos={"fade-up" } dataAosDelay={"600"}  buttonClassName={"mt-5 mx-auto lg:mx-0 flex text-sm lg:text-base items-center spacing-3 gap-3 btn px-4 py-2 rounded-md my-5 text-white bg-lemon hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700"} />
    ...
    {/* <div className=' grid place-items-center h-full ' >
        <img src={aboutImage} className='object-contain ' alt="" />
    </div> */}
    {/* <div className='flex items-end justify-center lg:justify-around  h-full bg-red-400' data-aos="zoom-out" data-aos-delay="200" > */}
